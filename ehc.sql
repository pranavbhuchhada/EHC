...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 28, 2020 at 09:48 AM
...
('doctor', 'my new entry', 'My data for user pranav,\ngidshgidluyh,\nisdhuyhhjgfsjdf', 'My data for user pranav\nfjgfi', 'My data for user pranav', 'My data for user pranav', 'My data for user pranav', 'My data for user pranav'),
('lab', 'fsaiuhifbsdjbhkuyh, ibsdghbhnfdgjhbvfjyugbfisduyk', 'My data for user pranav,\r\ngidshgidluyh,\r\nisdhuyh', 'My data for user pranav', 'My data for user pranav', 'My data for user pranav', 'My data for user pranav', 'My data for user pranav'),
('pranav', 'hello ifgsdukygb\nflisdagyuk\nmy first entry\n', 'gdshu', 'kdfhbgsuakygMy data for user pranav', 'sfgtdrgkfisduyMy data for user pranav', 'khfyiMy data for user pranav', 'fdjuiMy data for user pranav', 'iiiiupjgdsioMy data for user pranav');
