...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-1">
        <h1 class="h3 mb-0 text-gray-800">Medication</h1>
    </div>
    <div class="card-body">
    ...
    <tbody>
        <tr>
            <td><input type="text" name="medname" class="form-control" required/></td>
            <td><input type="text" name="duration"  class="form-control"required/></td>
            <td><a class="deleteRow"></a><input type="button" class="ibtnDel btn btn-md btn-danger "  value="Delete"></td>
        </tr>
    </tbody>
</table>
</div>
<button type="button" class="btn btn-success" onclick="medication.php">Save</button>
  </div>
</div>
