...
<div class="card-body">
    ...
    <tbody>
        <tr>
            <td><input type="text" name="symptomsname" class="form-control" required/></td>
...
<button type="button" class="btn btn-success" onclick="symptoms.php">Save</button>
  </div>
</div>
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    $("#addrow").on("click", function () {
        ...
        cols += '<td><input type="text" class="form-control" name="symptomsname' + counter + '"/></td>';
