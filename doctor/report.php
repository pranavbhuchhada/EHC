...
<div class="card-body">
    ...
    <tbody>
        <tr>
            <td><input type="text" name="reportname" class="form-control" required/></td>
...
<button type="button" class="btn btn-success" onclick="report.php">Save</button>
  </div>
</div>
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    $("#addrow").on("click", function () {
        ...
        cols += '<td><input type="text" class="form-control" name="reportname' + counter + '"/></td>';
